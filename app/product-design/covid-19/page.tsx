          ...
          <div className="mt-6 pt-6 border-t border-border">
            <dl className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                ...
                <dd className="text-muted-foreground">2020-2022</dd>
              </div>
              <div>
        ...
        <article className="max-w-[1024px] mx-auto px-4 sm:px-6 pb-20 space-y-12">
          ...
          <section className="space-y-6">
            <p className={typography.body}>
              ...
              testing infrastructure. My role was leading the UX transformation of our entire genetic testing platform
              to meet urgent public health needs across multiple contexts: public health sites, corporate partnerships,
              K-12 schools, and university programs.
            </p>
          ...
          <section className="space-y-6">
            ...
            <p className={typography.body}>
              <strong>Context:</strong> Partnering with Bay Area public health departments to serve diverse communities
              of essential workers
            </p>

            <p className={typography.body}>
              <strong>The challenge:</strong> Our users were primarily mobile-first, often had limited data bandwidth,
              spoke different languages, and needed an experience simple enough to use during a health crisis.
            </p>

            <p className={typography.body}>
              <strong>My approach:</strong> Through user research, I discovered that most people would register and
              receive results on their phones, often with limited data. I designed mobile-first experiences with
              localized content that respected different cultural contexts and language needs. The registration and
              results flow had to be simple enough for someone to complete while stressed about their health, yet
              comprehensive enough to ensure proper follow-up care.
            </p>

            <p className={typography.body}>
              <strong>Impact:</strong> This user-centered approach became the model for our diagnostics tools that
              scaled nationwide and later influenced vaccination programs.
            </p>
          ...
          <section className="space-y-6">
            ...
            <p className={typography.body}>
              <strong>Context:</strong> Supporting businesses with onsite testing programs, starting with United
              Airlines at SFO
            </p>
            ...
            <p className={typography.body}>
              ...
              one-handed positioning that slowed down the entire process. By bringing this user insight back to my team,
              we implemented external barcode scanners.
            </p>

            <p className={typography.body}>
              <strong>Impact:</strong> Dramatically improved throughput and made clinicians' jobs easier, proving the
              value of field observation.
            </p>
          ...
          <section className="space-y-6">
            ...
            <p className={typography.body}>
              ...
              packages worked perfectly for office environments, children were dropping swabs during the collection
              process, leaving schools without enough supplies to test all students.
            </p>
          ...
          <section className="space-y-6">
            ...
            <p className={typography.body}>
              <strong>The challenge:</strong> Students had to swab themselves, find the right type of FedEx dropbox (not
              all accept biohazards), and complete everything within a specific window before returning to campus. One
              mistake meant the sample would expire, and their return to campus would be delayed.
            </p>

            <p className={typography.body}>
              <strong>My approach:</strong> Working closely with engineering, I designed content and workflows that
              broke down this complex logistics challenge into clear, actionable steps that students could successfully
          ...
          <section className="space-y-6">
            ...
            <p className={typography.body}>
              This work taught me that truly user-centered design means going beyond personas and surveys. You must show
              up where your users are, watch them work, and understand their real constraints.
            </p>
