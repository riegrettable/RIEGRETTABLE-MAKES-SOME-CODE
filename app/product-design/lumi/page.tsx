...
export default function LumiCaseStudy() {
  ...
  return (
    <CaseStudyLayout
      ...
      timeline="January 2025-Present (4 iterations)"
      team="Cross-functional: Engineering, Customer Success, ML"
      currentProjectId="lumi"
    >
      {/* Back Link */}
      <section className="space-y-6">
        ...
        <p className={typography.body}>
          Lumi specifically was technically impressive, but educationally harmful. The first iteration of our product
          wrote entire documents for students instead of helping them learn to write.
        </p>
      ...
      <section className="space-y-6">
        ...
        <p className={typography.body}>
          Led all research, product strategy, UX design, and implementation across four major iterations, from initial
          discovery and vision-setting through the current teacher customization platform.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <p className={typography.body}>
          Through roundtables with 20+ teachers across 5 districts and analysis of classroom usage patterns, I partnered
          with our Customer Success team to establish a research-backed vision for the product.
        </p>
        <p className={typography.body}>
          We analyzed research from institutions like MIT Media Lab to align our approach with evidence-based teaching
          methods. The research was clear: AI tools that provide answers undermine learning, while those that scaffold
          thinking and prompt reflection support it.
        </p>

        <p className={typography.body}>
          This led us to our North Star: <strong>Lumi as a Socratic teaching partner</strong> that guides students to
          their own answers, not a shortcut to completed work. This vision became the foundation for every product
          decision as we rebuilt the experience from the ground up.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <p className={typography.body}>
          I redesigned the product around educational scaffolding rather than content generation, rolling out changes
          iteratively based on real classroom feedback:
        </p>
        ...
        <div className="space-y-12">
          <div>
            ...
            <div className="mt-4 bg-muted/30 p-4 sm:p-6 rounded-lg border border-border">
              ...
              <p className={cn(typography.body, "mb-3 italic")}>
                "The hardest part about teaching is that I am spread too thin to coach all of my students, so lots of
                them don't get the attention they need."
              </p>
              <p className={typography.body}>
                <strong>Learning:</strong> Teachers revealed they weren't opposed to AI assistance - they desperately
                wanted tools that could provide the individual coaching they couldn't offer every student. But our
                current approach was replacing student thinking rather than supporting it.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className={typography.body}>
              Removed inline suggestions and introduced a "Get feedback" button where Lumi responds to student work in
              chat.
            </p>
            <div className="my-6 rounded-lg overflow-hidden">
              <ImageLightbox
            ...
            <div className="mt-4 bg-muted/30 p-4 sm:p-6 rounded-lg border border-border">
              ...
              <p className={typography.body}>
                ...
                grade-appropriate. We needed teacher control over what Lumi discusses to ensure it aligns with specific
                learning objectives.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className={typography.body}>
              Built a project configuration interface where teachers define rubrics, standards, and lesson plans that
              inform every AI interaction.
            </p>
            <div className="my-6 rounded-lg overflow-hidden">
              <ImageLightbox
            ...
            <div className="mb-4 flex items-start gap-3 p-4 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-900 rounded-lg">
              <span className="text-2xl">✅</span>
              <p className={cn(typography.body, "text-green-900 dark:text-green-100")}>
                <strong>Progress:</strong> Teachers could now customize feedback to align with their specific curriculum
                and learning goals.
              </p>
            </div>
            <div className="mt-4 bg-muted/30 p-4 sm:p-6 rounded-lg border border-border">
              <p className={cn(typography.body, "mb-3 italic")}>
                "This seems like it would really help lift up my students who get stuck. I don't have time to work with
                all of them one-on-one, and I don't have a teaching assistant this year, so this sort of thing can help
                fill gaps for me."
              </p>
              <p className={typography.body}>
          ...
          <div>
            ...
            <p className={typography.body}>
              ...
              teacher-configured guidance at each stage. Added analytics so teachers can assess how students engage with
              AI, not just their output.
            </p>
            <div className="my-6 rounded-lg overflow-hidden">
              <ImageLightbox
            ...
            <div className="mt-4 bg-muted/30 p-4 sm:p-6 rounded-lg border border-border">
              ...
              <p className={typography.body}>
                <strong>Learning:</strong> Teachers love being in the drivers seat, but there is an opportunity for an
                AI agent that makes project customization more efficient.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-6">
        ...
        <p className={typography.body}>
          This is ongoing, incremental work. Each phase brings us closer to a Socratic, always-available teacher that
          enables personalized learning at scale while keeping it engaging for students and leaving teachers in control.
        </p>
      </section>
    </CaseStudyLayout>
  )
