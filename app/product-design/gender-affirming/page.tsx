          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="mt-12 mb-24">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 pt-8 border-t border-border">
                <div>
                  <h3 className={cn(typography.bodySm, "text-muted-foreground mb-2")}>Role</h3>
                  <p className={typography.body}>Lead Product Designer</p>
                </div>
                <div>
                  <h3 className={cn(typography.bodySm, "text-muted-foreground mb-2")}>Timeline</h3>
                  <p className={typography.body}>2020-2022</p>
                </div>
                <div>
                  <h3 className={cn(typography.bodySm, "text-muted-foreground mb-2")}>Team</h3>
                  <p className={typography.body}>Cross-functional: Engineering, Medical Affairs, Scientific</p>
                </div>
              </div>
            </div>
