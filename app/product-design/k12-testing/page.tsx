...
export default function K12TestingCaseStudy() {
  return (
    <CaseStudyLayout
      ...
      <div className="min-h-screen bg-background text-foreground">
        <section className="space-y-8 mb-16">
          <div>
            ...
            <p className={typography.body}>
              In fall 2020, Color Health was contracted by several public school districts to design and deploy a pooled
              testing program to help K-12 students return to in-person learning safely.
            </p>
            <p className={cn(typography.body, "mt-4")}>
              Pooled testing is when samples from multiple people are combined ("pooled") and tested together. If the
              pool tests negative, everyone in the pool is negative. If it tests positive, all samples need to be
              retested individually. This approach dramatically reduces testing costs and speeds up turnaround times,
              making it an effective solution for schools with limited budgets.
            </p>
          </div>
        ...
        <section className="mt-24 mb-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className={typography.body}>
              Designing for reopening workplaces would have different technical requirements and nuances than designing
              for reopening K-12 schools.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6">Iteration 1: Recycle Existing Product</h2>
          <p className={typography.body}>
          ...
          <p className={typography.body}>
            Under this assumption, I adapted the logged in homepage to reflect a list of pools instead of a list of all
            patients.
          </p>
          ...
          <div className="bg-muted/30 p-4 sm:p-6 rounded-lg border border-border mt-16">
            ...
            <p className={cn(typography.body, "mb-4")}>
              I created a prototype for the Commercial Team to share with potential customers. We received feedback from
              Cincinnati Public Schools which upended a handful of our assumptions.
            </p>
            ...
            <p className={typography.body}>
              Students often moved between classrooms and schools within a district, so it would be difficult to manage
              in the Admin Dashboard or on Color's backend
            </p>
          </div>
        </section>
        ...
        {/* Negotiating timelines callout */}
        <section className="mb-16 bg-yellow-50 p-6 sm:p-8 rounded-lg border-l-4 border-yellow-400 shadow-sm">
          <h2 className={cn(typography.h2, "mb-4 text-yellow-900")}>Negotiating timelines</h2>
          <p className={cn(typography.body, "mb-4")}>
            It would not be possible for our engineer to build the search-first solution in one week. We either needed
            to develop the list view UI, which we knew was not usable, or we needed a deadline extension to build the
            search-first experience.
          </p>
          <p className={typography.body}>
            Because the Commercial Team had seen firsthand the value of the search-first experience, my team received a
            deadline extension. But now, I had a new design challenge: the UI needed to be optimized for mobile.
          </p>
        </section>

        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6">Iteration 3: Mobile Responsive</h2>
          <p className={typography.body}>
            I initially attempted to include search, the patient list, and the list of participants in the pool in the
            mobile UI.
          </p>

          <div className="my-8">
            <Image
              src="/images/iteration-3.webp"
              alt="Mobile responsive design iteration showing three main issues: list of participants not visible on mobile, search bar moving as pool list grows, and difficult CTA patterns"
              width={1600}
              height={900}
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6">What We Built</h2>
          <p className={typography.body}>
            At this point, we had a usable, mobile responsive solution for Pooled Testing that was validated by real
            users and could be feasibly built by our engineering in the new timeline. My team successfully designed and
            shipped a patient experience, a clinician experience in the Onsite Tool, and new analytics features for the
            Admin Dashboard.
          </p>

          <div className="mt-8 space-y-8">
            <div>
              <h3 className={cn(typography.h3, "mb-4")}>Patient-facing registration and results:</h3>
              <Image
                src="/images/patient-registration-results.webp"
                alt="Patient-facing registration and results interface showing mobile screens with scheduling and test result notifications"
                width={1600}
                height={600}
            ...
            <div>
              <h3 className={cn(typography.h3, "mb-4")}>Clinician-facing Onsite Tool:</h3>
              <Image
                src="/images/clinician-onsite-tool.webp"
                alt="Clinician-facing onsite tool showing 4-step workflow for creating a new pool: start pool, add participants, add labels, and finish"
                width={1600}
                height={400}
                className="w-full rounded-lg"
              />
            ...
            <div>
              <h3 className={cn(typography.h3, "mb-4")}>Additional analytics features in the Admin Dashboard:</h3>
              <Image
                src="/images/admin-dashboard-analytics.webp"
                alt="Admin dashboard showing COVID-19 testing data with filtering capabilities for Cincinnati Public Schools"
                width={1600}
                height={900}
                className="w-full rounded-lg"
              />
        ...
        <section className="mb-16">
          ...
          <p className={typography.body}>
            I visited a Cincinnati Public School during the launch of Pooled Testing, and while the digital experience
            was easily for school staff to use, I discovered that we were going to need more swabs. Color supplied its
            own test kits to schools, including swabs; the number of swabs was equal to the number of students at the
            school. However, young schoolchildren don't have perfect dexterity. I noticed that they would often drop
            swabs on the ground, touch them with their fingers, or find other ways to contaminate them. This meant that
            the school ran out of swabs before testing was complete. I brought this feedback to the broader team at
            Color, and we updated the supplies we sent to schools to improve the pooled testing experience.
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className={typography.body}>
            We quickly met technical, ambiguous testing needs in 2021 with a user-centered approach, and this approach
            also established design as a thought partner across Color. Through research and insights about real users
            and the context in which they work, we built an effective solution that also created a paradigm shift within
            Color.
          </p>
          <p className={typography.body}>
            Because the commercial team witnessed firsthand the value of an iterative design process and feedback from
            real users, we moved from an assumption-based model to a user-informed model as an organization.
          </p>
          <p className={typography.body}>
            The market shifted, and towards the end of 2021, vaccines were becoming available. Then, in 2022, vaccines
            and rapid tests became readily available, so the need for affordable lab testing diminished.
          </p>
        </section>
      </div>
    </CaseStudyLayout>
