        ...
        <div className="space-y-8">
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                • Responsible for 0 to 1 product design, including a suite of creator tools for students and a suite of
                analytics tools for teachers and school administrators.
              </li>
              <li>
              ...
              <li>
                • Facilitated design sprints to drive strategic and tactical alignment across product, engineering, and
                customer success.
              </li>
              <li>
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                • Led UX design for a multi-platform MVP, creating contractor-friendly workflows that scaled into a full
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                • Created a scalable, inclusive design system that reduced medical barriers across healthcare offerings.
              </li>
              <li>
                • Partnered with Genetic Counselors to redesign genetic testing result delivery, improving accessibility
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                • Led design and research during pivot from dating to social app, focusing on inclusive features (social
                feed, events, community tools) that boosted engagement.
              </li>
